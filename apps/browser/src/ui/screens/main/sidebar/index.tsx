...
export function Sidebar() {
  ...
  return (
    <ResizablePanel
      ...
      className="@container group overflow-visible! flex h-full flex-col items-stretch justify-between gap-3 rounded-lg bg-background p-1 ring-1 ring-derived-strong data-[collapsed=false]:min-w-64 data-[collapsed=false]:max-w-2xl data-[collapsed=true]:max-w-0 data-[collapsed=true]:p-0 data-[collapsed=true]:ring-transparent"
    >
