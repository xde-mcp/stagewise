...
import { readStagewiseMd } from '../utils/read-stagewise-md.js';
import type { AggregatedDiagnostic } from '../../../workspace/services/lsp/index.js';
...
export async function getSystemPrompt(
  ...
  let projectMode: 'project-connected' | 'project-not-connected';
  if (clientRuntime === null) projectMode = 'project-not-connected';
  else projectMode = 'project-connected';
...
/**
 * Notice shown when STAGEWISE.md has not yet been generated for the project.
 */
const getStagewiseMdNotice = () => {
  return xml({
    'stagewise-md-notice': {
      _attr: {
...
const currentGoal = (
  _kartonState: KartonContract['state'],
