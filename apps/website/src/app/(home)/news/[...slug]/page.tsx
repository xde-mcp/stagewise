      ...
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <div className="flex flex-row gap-4">
          <Link
            ...
            className="flex h-8 items-center justify-center rounded-sm bg-[#0b66c2] px-4 text-sm text-white hover:opacity-80"
          >
          ...
          <Link
            ...
            className="flex h-8 items-center justify-center rounded-sm bg-black px-4 text-sm text-white hover:opacity-80"
          >
