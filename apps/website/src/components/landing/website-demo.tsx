  ...
  return (
    <div
      className={`cursor-default select-none transition-all duration-300 ease-in-out ${
        isActive
          ? 'bg-gradient-to-r from-indigo-600 to-pink-600 px-6 py-3 text-white'
          : 'rounded-full bg-black px-8 py-3 text-white'
      } font-medium ring-2 ring-indigo-500 ring-offset-2 ring-offset-gray-900`}
    >
      Download now
    </div>
  );
...
export function WebsiteDemo() {
  ...
  return (
    <div className="w-full max-w-4xl rounded-lg border border-indigo-300/40 bg-white shadow-lg transition-transform duration-500 dark:border-indigo-800/40 dark:bg-gray-900 dark:shadow-[0_0_30px_rgba(128,90,213,0.2)]">
      {/* Browser Top Bar */}
      ...
      <div className="p-6">
          ...
          <div className="relative">
            ...
            {status !== 'hidden' && (
              <div className="-translate-x-1/2 sm:-translate-y-1/2 sm:-translate-x-0 absolute top-full left-1/2 z-10 mt-4 w-xs sm:top-1/2 sm:left-full sm:mt-0 sm:ml-4">
                <div className="h-20 rounded-lg border border-indigo-300/40 bg-white p-4 shadow-lg dark:border-indigo-800/30 dark:bg-gray-800">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-lg border border-gray-200 bg-white p-4 transition-colors hover:border-indigo-300/40 dark:border-gray-800 dark:bg-gray-900 hover:dark:border-indigo-800/30">
